...
//            $important_keys = array();
    ...
    public $LastRead;
    public $MessageType;
    public $CollaborationIdentifier;
    public $MainGroup;
    public $CreatorID;
    ...
    public $Order;
    public $ContentObjectStateID;
    public $DiscountRuleID;
    public $DiscountPercent;
    public $Limitation;
    public $DiscountSubRuleID;
    public $Value;
    public $IsSection;
    public $HashKey;
    public $Time;
    public $ReceiveDigest;
    public $DigestType;
    public $Day;
    public $Description;
    public $GroupNumber;
    ...
    public $GroupTo;
    public $GroupLength;
    public $RegistrantFrom;
    public $RegistrantTo;
    public $RegistrantLength;
    public $ISBNGroupID;
    public $id;
    public $UserIdentifier;
    public $InformationCollectionID;
    public $ContentObjectAttributeID;
    public $DataText;
    public $DataInt;
    public $DataFloat;
    public $ContentObjectAttrID;
    public $ContentObjectAttrVersion;
    public $Type;
    public $EventID;
    public $Handler;
    public $Transport;
